...
export default function PartOne() {
    ...
    const calcAverage = () => {
        ...
        for (let i = 0; i < 3; i++) {
            const numberInput: number | null = parseFloat(
        ...
        console.log(
            `A média dos números é de: ${(total / numbers.length).toFixed(1)}`
        );
    };
    ...
    const evenOrOdd = () => {
        ...
        const numberInput: number | null = parseFloat(
            prompt("Informe o valor que deseja verificar: ")
        );
        ...
        numberInput % 2 !== 0
            ? console.log(`O número ${numberInput} é impar!`)
            : console.log(`O número ${numberInput} é par!`);
    };

    const celciusToFahrenheit = () => {
        const celciusPrompt: number | null = parseFloat(
            prompt("Insira o valor que deseja ")
        );
        ...
        console.log(
            `A temperatura convertida para Fahrenheit é: ${fahrenheitValue}F`
        );
    };

    const primeNumber = () => {
        const numberInput: number | null = parseFloat(
            prompt(`Insira o número que deseja verificar: `)
        );
    ...
    const factorialNumber = () => {
        const numberInput: number | null = parseInt(
            prompt("Insira o número que deseja calcular: ")
        );
        let result: number = 1;
    ...
    const fizzAndBuzz = () => {
        ...
        console.log(
            "Convertando múltiplos de 3 para Fizz, de 5 para Buzz e de 3"
        );
        console.log("Números antes da conversão: \n", arrItens);

        for (let i = 0; i < arrItens.length; i++) {
            if (
                parseInt(arrItens[i]) % 3 === 0 &&
                parseInt(arrItens[i]) % 5 === 0
            ) {
                arrItens[i] = "FizzBuzz";
    ...
    const secondsToHourFomate = () => {
        ...
        console.log(
            `O valor 7384 segundos, convertido para horas, resulta em: ${padStartFormatter(
                hour,
                2,
                "0"
            )}:${padStartFormatter(minutes, 2, "0")}:${padStartFormatter(
                seconds,
                2,
                "0"
            )}`
    ...
    const numberPalindrome = () => {
        ...
        const numberInput: number | null = parseFloat(
            prompt("Informe o número que deseja verificar: ")
        );
    ...
    const fibonacciSequence = () => {
        const numberInput: number | null = Number(
            prompt("Insira o valor alvo para o calculo: ")
        );
        ...
        console.log(
            `O número final da sequencia Fibonacci para o número ${numberInput} é: ${fibB}`
        );
    };
